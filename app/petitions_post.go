...
func (srv *Service) PetitionsPostHandler(params apiPetitions.PetitionsPostParams, principal *models.Principal) middleware.Responder {
	//Email validation
	...
	petition, err := srv.petitionCreate(params)
	if err != nil {
